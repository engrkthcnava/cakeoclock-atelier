...
const PRODUCT_MENU = [
  ...
  { id: 'rvcake', name: 'Red Velvet Cake Slice', price: 150, img: rvcake },
  { id: 'chocolava', name: 'Chocolava Butternut', price: 160, img: chocolava },
  { id: 'oreobanana', name: 'Oreo Banana Cake', price: 140, img: oreobanana },
  { id: 'choco', name: 'Classic Chocolate Cake', price: 350, img: choco },
  { id: 'dcc', name: 'Dubai Chewy Cookie', price: 280, img: dcc },
];
...
// ==========================================================================
  ...
  }; // 👈 Ensure there is ONLY ONE closing bracket here before the "return" statement starts!

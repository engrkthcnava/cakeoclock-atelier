...
const app = express();
const PORT = 5000;
const DB_FILE = path.join(__dirname, 'beannbite_reservations.db');
...
app.post('/api/inquiry', (req, res) => {
  ...
  db.run(sql, params, function (err) {
    ...
    const customerMailOptions = {
      from: '"Cake o\' Clock" <kathleennava.work@gmail.com>',
      to: email, 
      subject: '🧁 We got your Cake o\' Clock pre-order request!',
      html: `
    ...
    const ownerMailOptions = {
      from: '"Cake o\' Clock System Alert" <kathleennava.work@gmail.com>',
